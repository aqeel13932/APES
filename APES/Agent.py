...
"""
    def __init__(self,Fname='Pics/agent_W.jpg',Power=1,Range=-1,VisionAngle=90,ControlRange=3,See=True,PdstName=None,EgoCentric=False,Multiplex=1,ActionMemory=0):
        ...
        Args:
            ...
            * Power: integer represent agent power, the more the stronger.
            * Range: integer represent Agent sight range.(how far agent can see -1 full vision) 
        ...
        self.Range=Range # How far agent can see.
